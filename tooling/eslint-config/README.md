# @bestaff/eslint-config

<div align="center">

Shared ESLint configurations for the BestAff Mobile monorepo.
...
This package contains shared ESLint configurations used across all packages and applications in the BestAff Mobile monorepo. It enforces consistent code quality, style, and best practices.
...
{
  "devDependencies": {
    "@bestaff/eslint-config": "workspace:*"
  }
}
```
...
```javascript
import { config } from '@bestaff/eslint-config/react';
