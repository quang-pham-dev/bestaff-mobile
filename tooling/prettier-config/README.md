# @bestaff/prettier-config

<div align="center">

Shared Prettier configuration for the BestAff Mobile monorepo.
...
This package contains the shared Prettier configuration used across all packages and applications in the BestAff Mobile monorepo. It ensures consistent code formatting throughout the codebase.
...
{
  "devDependencies": {
    "@bestaff/prettier-config": "workspace:*"
  }
}
```
...
```javascript
const baseConfig = require('@bestaff/prettier-config/base');
...
```json
{
  "prettier": "@bestaff/prettier-config/base"
}
```
...
```javascript
// ✅ Use base config
module.exports = require('@bestaff/prettier-config/base');
...
```json
{
  "extends": ["@bestaff/eslint-config", "prettier"]
}
```
