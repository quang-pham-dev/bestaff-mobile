...
/**
 * Hook to check if it is the first time the user is opening the app.
 * Uses Expo SecureStore to persist the state.
 *
 * @returns A tuple containing the boolean state and a function to set the state.
 *
 * @example
 * ```tsx
